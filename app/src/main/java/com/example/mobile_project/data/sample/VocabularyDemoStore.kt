...
object VocabularyDemoStore {
    ...
    fun saveSet(
        ...
        val resolvedSetId = if (existingIndex >= 0) {
            vocabularySets[existingIndex].setId
        } else {
            buildId("set", normalizedTitle)
        }
    ...
    fun saveWord(
        ...
        val resolvedWordId = if (existingIndex >= 0) {
            vocabularies[existingIndex].wordId
        } else {
            buildId("word", normalizedWord)
        }
